          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="rounded-2xl border border-border-subtle/60 bg-surface/60 p-3">
                ...
                <p className="mt-2 text-2xl font-bold text-status-active">{activeCount}</p>
              </div>
              <div className="rounded-2xl border border-border-subtle/60 bg-surface/60 p-3">
                <p className="text-[11px] uppercase tracking-[0.16em] text-text-muted">Revocadas</p>
                <p className="mt-2 text-2xl font-bold text-status-revoked">{revokedCount}</p>
              </div>
              <div className="rounded-2xl border border-border-subtle/60 bg-surface/60 p-3">
                <p className="text-[11px] uppercase tracking-[0.16em] text-text-muted">Expiradas</p>
                <p className="mt-2 text-2xl font-bold text-status-expired">{expiredCount}</p>
              </div>
            </div>
            </div>
              ...
              <div className="rounded-2xl border border-border-subtle/60 bg-gradient-to-br from-surface/70 to-mf-darker/60 p-3">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <Button
                    ...
                    className="h-auto min-h-[82px] justify-start rounded-2xl border-emerald-500/20 bg-emerald-500/8 px-4 py-3 text-left hover:border-emerald-400/40 hover:bg-emerald-500/12"
                  >
                  ...
                  <Button
                    ...
                    className="h-auto min-h-[82px] justify-start rounded-2xl border-rose-500/20 bg-rose-500/8 px-4 py-3 text-left hover:border-rose-400/40 hover:bg-rose-500/12"
                  >
