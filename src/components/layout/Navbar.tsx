...
export function Navbar() {
  ...
  const navItems = [
    ...
    { to: '/whitelist', label: 'Whitelist IP' },
        ...
        <div className="flex min-h-16 items-center justify-between gap-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <span className="font-bold text-gradient text-lg tracking-tight">GeoShield Whitelist</span>
              <p className="text-xs text-text-muted">Panel operativo de soporte</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button variant="ghost" size="sm" className="hidden md:inline-flex px-3" onClick={handleLogout} title="Cerrar Sesión">
